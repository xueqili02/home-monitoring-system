...
from model.fall_detect_track.Detection.Models import Darknet
from model.fall_detect_track.Detection.Utils import non_max_suppression, ResizePadding
...
class TinyYOLOv3_onecls(object):
    ...
    def __init__(self,
                 input_size=416,
                 config_file='model/fall_detect_track/Models/yolo-tiny-onecls/yolov3-tiny-onecls.cfg',
                 weight_file='model/fall_detect_track/Models/yolo-tiny-onecls/best-model.pth',
                 nms=0.2,
                 conf_thres=0.45,
                 device='cuda'):
    ...
    def detect(self, image, need_resize=True, expand_bb=5):
        ...
        return detected
        # return limit_bbox_count(detected, max_count=5)
