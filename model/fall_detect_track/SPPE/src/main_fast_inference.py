...
import numpy as np
from model.fall_detect_track.SPPE.src.utils.img import flip, shuffleLR
from model.fall_detect_track.SPPE.src.utils.eval import getPrediction
from model.fall_detect_track.SPPE.src.models.FastPose import FastPose
...
class InferenNet_fastRes50(nn.Module):
    def __init__(self, weights_file='model/fall_detect_track/Models/sppe/fast_res50_256x192.pth'):
        super().__init__()
