...
from model.fall_detect_track.Actionsrecognition.Models import TwoStreamSpatialTemporalGraph
from model.fall_detect_track.pose_utils import normalize_points_with_size, scale_pose
...
class TSSTG(object):
    ...
    """
    def __init__(self,
                 weight_file='model/fall_detect_track/Models/TSSTG/tsstg-model.pth',
                 device='cuda'):
